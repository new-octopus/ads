...
function signin($username, $password){
	...
	if ($username_db==$login_username && $login_password==$password_db) { 
		if ($account_status=="1"){ 
			...
			mysql_query("INSERT INTO `md_usessions`(`session_id`,`session_timeout`,`session_status`,`user_identification`,`user_password`,`session_type`,`ip_address`,`date_created`) VALUES('$sessid', '$date_n', '1', '$username', '$login_password', '1', '', '".time()."')", $maindb);
